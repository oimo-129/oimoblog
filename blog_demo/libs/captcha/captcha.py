...
# - random 用于生成随机字符
# - string 用于字符处理
# - io.BytesIO 用于内存中处理图像数据

# 核心类：
# - Bezier：用于生成贝塞尔曲线，实现验证码图片的扭曲效果

# 文件参考了wheezy.captcha项目的实现：
# https://bitbucket.org/akorn/wheezy.captcha
